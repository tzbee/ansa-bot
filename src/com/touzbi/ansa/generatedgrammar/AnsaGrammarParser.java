...
public class AnsaGrammarParser extends Parser {
	...
	public static final int T__3 = 1, T__2 = 2, T__1 = 3, T__0 = 4,
			LINE_COMMENT = 5, FORMAT = 6, GET_CONTENT_BY_REGEX = 7,
			GET_HTML_TEXT = 8, DOWNLOAD = 9, HTTP_REQUEST = 10,
			GET_HTML_ATTRIBUTE = 11, SYSOUT = 12, PARAM_ID = 13,
	...
	public static final String[] tokenNames = { "<INVALID>", "')'", "','",
			...
			"'gethtmlattribute'", "'print'", "PARAM_ID", "':'",
			"QUOTED_STRING", "'''", "WS" };
	public static final int RULE_init = 0, RULE_commandBlock = 1,
			RULE_commandId = 2, RULE_format = 3, RULE_getcontentbyregex = 4,
			RULE_gethtmltext = 5, RULE_download = 6, RULE_httprequest = 7,
			RULE_gethtmlattribute = 8, RULE_sysout = 9, RULE_paramBlock = 10,
			RULE_paramList = 11, RULE_paramPair = 12, RULE_paramName = 13,
			RULE_paramValue = 14;
	public static final String[] ruleNames = { "init", "commandBlock",
			"commandId", "format", "getcontentbyregex", "gethtmltext",
			"download", "httprequest", "gethtmlattribute", "sysout",
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << FORMAT)
						| (1L << GET_CONTENT_BY_REGEX) | (1L << GET_HTML_TEXT)
						| (1L << DOWNLOAD) | (1L << HTTP_REQUEST)
						| (1L << GET_HTML_ATTRIBUTE) | (1L << SYSOUT))) != 0)) {
					{
						{
							setState(30);
							commandBlock();
	...
	public static final String _serializedATN = "\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\3\23[\4\2\t\2\4\3\t"

...
public class AnsaGrammarParser extends Parser {
	...
	public static final int RULE_init = 0, RULE_commandBlock = 1,
			RULE_commandId = 2, RULE_download = 3, RULE_format = 4,
			RULE_getcontent = 5, RULE_httprequest = 6, RULE_sysout = 7,
			RULE_input = 8, RULE_paramBlock = 9, RULE_paramList = 10,
			RULE_paramPair = 11, RULE_paramName = 12, RULE_paramValues = 13,
			RULE_paramValue = 14;
	public static final String[] ruleNames = { "init", "commandBlock",
			"commandId", "download", "format", "getcontent", "httprequest",
			"sysout", "input", "paramBlock", "paramList", "paramPair",
	...
	public static class GetcontentContext extends ParserRuleContext {
		public TerminalNode GET_CONTENT() {
			return getToken(AnsaGrammarParser.GET_CONTENT, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof AnsaGrammarListener)
				((AnsaGrammarListener) listener).enterGetcontent(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof AnsaGrammarListener)
				((AnsaGrammarListener) listener).exitGetcontent(this);
		}
	}
	...
	public static class InputContext extends ParserRuleContext {
		public TerminalNode INPUT() {
			return getToken(AnsaGrammarParser.INPUT, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof AnsaGrammarListener)
				((AnsaGrammarListener) listener).enterInput(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof AnsaGrammarListener)
				((AnsaGrammarListener) listener).exitInput(this);
		}
	}
	...
	public static class ParamValuesContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_paramValues;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof AnsaGrammarListener)
				((AnsaGrammarListener) listener).enterParamValues(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof AnsaGrammarListener)
				((AnsaGrammarListener) listener).exitParamValues(this);
		}
	}
	...
	public static final String _serializedATN = "\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\3\24f\4\2\t\2\4\3\t"

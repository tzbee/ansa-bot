...
public class AnsaGrammarParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "')'", "','", "'('", "';'", "LINE_COMMENT", "'getcontentbyregex'", 
		"'gethtmltext'", "'download'", "'httprequest'", "'gethtmlattribute'", 
		"'sysout'", "PARAM_ID", "':'", "QUOTED_STRING", "'''", "WS"
	};
	public static final int
		RULE_init = 0, RULE_commandBlock = 1, RULE_commandId = 2, RULE_getcontentbyregex = 3, 
		RULE_gethtmltext = 4, RULE_download = 5, RULE_httprequest = 6, RULE_gethtmlattribute = 7, 
		RULE_sysout = 8, RULE_paramBlock = 9, RULE_paramList = 10, RULE_paramPair = 11, 
		RULE_paramName = 12, RULE_paramValue = 13;
	public static final String[] ruleNames = {
		"init", "commandBlock", "commandId", "getcontentbyregex", "gethtmltext", 
	...
	public final InitContext init() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << GET_CONTENT_BY_REGEX) | (1L << GET_HTML_TEXT) | (1L << DOWNLOAD) | (1L << HTTP_REQUEST) | (1L << GET_HTML_ATTRIBUTE) | (1L << SYSOUT))) != 0)) {
				{
				{
	...
	public final CommandIdContext commandId() throws RecognitionException {
		...
		try {
			...
			case GET_HTML_ATTRIBUTE:
				...
				{
				setState(44); gethtmlattribute();
				}
				break;
			case GET_HTML_TEXT:
				enterOuterAlt(_localctx, 3);
				{
				setState(45); gethtmltext();
				}
				break;
			case GET_CONTENT_BY_REGEX:
				enterOuterAlt(_localctx, 4);
				{
				setState(46); getcontentbyregex();
				}
				break;
			case HTTP_REQUEST:
	...
	public final GetcontentbyregexContext getcontentbyregex() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(51); match(GET_CONTENT_BY_REGEX);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GethtmltextContext gethtmltext() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(53); match(GET_HTML_TEXT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final HttprequestContext httprequest() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(57); match(HTTP_REQUEST);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GethtmlattributeContext gethtmlattribute() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(59); match(GET_HTML_ATTRIBUTE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ParamPairContext paramPair() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(75); paramName();
			setState(76); match(PARAM_DELIMITER);
	...
	public final ParamValueContext paramValue() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(81); match(QUOTED_STRING);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;

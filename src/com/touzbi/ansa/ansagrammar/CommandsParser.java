...
public class CommandsParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'getcontentbyregex'", "'gethtmltext'", "'download'", "'httprequest'", 
		"'gethtmlattribute'", "'sysout'"
	};
	public static final int
		RULE_commandId = 0, RULE_getcontentbyregex = 1, RULE_gethtmltext = 2, 
		RULE_download = 3, RULE_httprequest = 4, RULE_gethtmlattribute = 5, RULE_sysout = 6;
	public static final String[] ruleNames = {
		"commandId", "getcontentbyregex", "gethtmltext", "download", "httprequest", 
		"gethtmlattribute", "sysout"
	};
	...
	public final CommandIdContext commandId() throws RecognitionException {
		...
		try {
			...
			case GET_HTML_ATTRIBUTE:
				...
				{
				setState(15); gethtmlattribute();
				}
				break;
			case GET_HTML_TEXT:
				enterOuterAlt(_localctx, 3);
				{
				setState(16); gethtmltext();
				}
				break;
			case GET_CONTENT_BY_REGEX:
				enterOuterAlt(_localctx, 4);
				{
				setState(17); getcontentbyregex();
				}
				break;
			case HTTP_REQUEST:
				enterOuterAlt(_localctx, 5);
				{
				setState(18); httprequest();
				}
				break;
			case DOWNLOAD:
	...
	public final GetcontentbyregexContext getcontentbyregex() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(22); match(GET_CONTENT_BY_REGEX);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GethtmltextContext gethtmltext() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(24); match(GET_HTML_TEXT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GethtmlattributeContext gethtmlattribute() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(30); match(GET_HTML_ATTRIBUTE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;

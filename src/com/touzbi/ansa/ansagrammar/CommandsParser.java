...
public class CommandsParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'getcontent'", "'httprequest'", "'sysout'", "'setinput'"
	};
	public static final int
		RULE_commandId = 0, RULE_getcontent = 1, RULE_httprequest = 2, RULE_sysout = 3, 
		RULE_input = 4;
	...
	public final CommandIdContext commandId() throws RecognitionException {
		...
		try {
			...
			case HTTP_REQUEST:
				...
				{
				setState(12); httprequest();
				}
				break;
			case GET_CONTENT:
				enterOuterAlt(_localctx, 4);
				{
				setState(13); getcontent();
				}
				break;
			default:
	...
	public final HttprequestContext httprequest() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(18); match(HTTP_REQUEST);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;

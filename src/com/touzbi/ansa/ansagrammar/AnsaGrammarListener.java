...
public interface AnsaGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AnsaGrammarParser#gethtmlattribute}.
	 * @param ctx the parse tree
	 */
	void enterGethtmlattribute(@NotNull AnsaGrammarParser.GethtmlattributeContext ctx);
	/**
	 * Exit a parse tree produced by {@link AnsaGrammarParser#gethtmlattribute}.
	 * @param ctx the parse tree
	 */
	void exitGethtmlattribute(@NotNull AnsaGrammarParser.GethtmlattributeContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link AnsaGrammarParser#getcontentbyregex}.
	 * @param ctx the parse tree
	 */
	void enterGetcontentbyregex(@NotNull AnsaGrammarParser.GetcontentbyregexContext ctx);
	/**
	 * Exit a parse tree produced by {@link AnsaGrammarParser#getcontentbyregex}.
	 * @param ctx the parse tree
	 */
	void exitGetcontentbyregex(@NotNull AnsaGrammarParser.GetcontentbyregexContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link AnsaGrammarParser#gethtmltext}.
	 * @param ctx the parse tree
	 */
	void enterGethtmltext(@NotNull AnsaGrammarParser.GethtmltextContext ctx);
	/**
	 * Exit a parse tree produced by {@link AnsaGrammarParser#gethtmltext}.
	 * @param ctx the parse tree
	 */
	void exitGethtmltext(@NotNull AnsaGrammarParser.GethtmltextContext ctx);

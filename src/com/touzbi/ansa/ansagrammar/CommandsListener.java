...
public interface CommandsListener extends ParseTreeListener {
	 ...
	 */
	void enterGethtmlattribute(@NotNull CommandsParser.GethtmlattributeContext ctx);
	/**
	 * Exit a parse tree produced by {@link CommandsParser#gethtmlattribute}.
	 * @param ctx the parse tree
	 */
	void exitGethtmlattribute(@NotNull CommandsParser.GethtmlattributeContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterGetcontentbyregex(@NotNull CommandsParser.GetcontentbyregexContext ctx);
	/**
	 * Exit a parse tree produced by {@link CommandsParser#getcontentbyregex}.
	 * @param ctx the parse tree
	 */
	void exitGetcontentbyregex(@NotNull CommandsParser.GetcontentbyregexContext ctx);
